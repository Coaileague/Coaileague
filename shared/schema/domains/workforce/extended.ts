...
export const applicants = pgTable("applicants", {
  ...
  trinityLiabilityIndicators: jsonb("trinity_liability_indicators"),
  trinityRecommendation: varchar("trinity_recommendation"),
  trinityScoredAt: timestamp("trinity_scored_at"),
  crossTenantFlag: boolean("cross_tenant_flag").default(false),
  crossTenantFlagReason: text("cross_tenant_flag_reason"),
...
export const jobPostings = pgTable("job_postings", {
  ...
  requiresArmedLicense: boolean("requires_armed_license").default(false),
  siteType: varchar("site_type"),
  stateJurisdiction: varchar("state_jurisdiction", { length: 2 }).default('TX'),
  bilingualRequired: boolean("bilingual_required").default(false),
