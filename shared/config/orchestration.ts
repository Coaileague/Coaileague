...
export const SUBAGENT_REGISTRY: SubagentDefinition[] = [
  ...
  },
  {
    ...
    allowedRoles: [...ROLE_GROUPS.PLATFORM_OPS, 'org_owner', 'org_admin'],
    bypassRoles: ['root_admin', 'deputy_admin'],
    isActive: true,
  ...
  // EXECUTOR TIER - Domain specialists
  {
    ...
    allowedRoles: [...ROLE_GROUPS.SUPPORT_TEAM, 'org_owner', 'org_admin', 'department_manager'],
    bypassRoles: ['root_admin', 'deputy_admin'],
    isActive: true,
  ...
  },
  {
    ...
    allowedRoles: [...ROLE_GROUPS.PLATFORM_OPS, 'compliance_officer', 'org_owner', 'org_admin'],
  ...
  },
  {
    ...
    allowedRoles: [...ROLE_GROUPS.SUPPORT_TEAM, 'org_owner', 'org_admin', 'department_manager', 'supervisor', 'staff', 'Bot'],
    bypassRoles: ['root_admin', 'deputy_admin', 'Bot'],
    isActive: true,
  ...
  },
  {
    ...
    allowedRoles: [...ROLE_GROUPS.PLATFORM_ADMINS, 'org_owner', 'org_admin'],
    bypassRoles: ['root_admin'],
    isActive: true,
