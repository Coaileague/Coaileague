...
- **AI Tool Capability Catalog:** Dynamic tool registry with success metrics, health signals, and usage statistics. Enables intelligent tool recommendations based on historical performance and user context. Auto-refreshes from automation ledger data.
