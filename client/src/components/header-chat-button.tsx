...
import { Bug, X, Headset, Send } from 'lucide-react';
  ...
  return (
    <>
      ...
      <Button
        ...
        title={showChat ? "Close support chat" : "Report a bug"}
      >
          ...
          <div className="bg-card border rounded-lg shadow-2xl flex flex-col h-[500px]">
            ...
            <div className="flex-1 overflow-y-auto p-3 space-y-3">
              <div className="flex gap-2">
                <div className="w-6 h-6 rounded-full bg-gradient-to-r from-violet-600 to-indigo-600 flex items-center justify-center flex-shrink-0">
                  <Bug className="w-3 h-3 text-white" />
                </div>
                <div className="bg-muted rounded-lg px-3 py-2 text-sm">
                  <p>Found a bug? Let us know what happened.</p>
                </div>
              </div>
            </div>
