  ...
  return (
    <CanvasHubPage config={pageConfig}>
      <div className="space-y-6">
        <div>
          <h1 className="text-2xl font-bold text-foreground tracking-tight">{orgName} — Management Dashboard</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-card border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 group card-float-sm">
            ...
            <p className="text-2xl font-bold text-foreground tracking-tight">{totalPending}</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 group card-float-sm">
            ...
            <p className="text-2xl font-bold text-foreground tracking-tight">{pendingShifts.length}</p>
          </div>
          ...
          <div className="bg-card border border-border rounded-xl p-4 shadow-sm hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 group card-float-sm">
            ...
            <p className="text-2xl font-bold text-foreground tracking-tight">{pendingExpenses.length}</p>
          </div>
        </div>
