...
function ApplicationForm({
  ...
  const mut = useMutation({
    mutationFn: () => apiRequest("POST", `/api/public/jobs/${workspaceId}/apply`, {
      ...
      license_number: form.has_license === "yes" ? form.license_number : null,
      license_state: form.has_license === "yes" ? form.license_state : null,
      license_type: form.has_license === "yes" ? form.license_type : null,
