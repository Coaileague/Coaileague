  ...
  const tiers: PricingTier[] = [
    {
      name: "Starter",
      price: "$299",
      savings: "Save $8k/month",
      roi: "27x ROI",
      description: "Essential workforce automation for small teams",
      ...
      features: [
        ...
        { name: "RecordOS™ - Natural Language Search", included: false },
    ...
    },
    {
      name: "Professional",
      price: "$799",
      savings: "Save $25k/month",
      roi: "31x ROI",
      description: "AI-powered workforce intelligence with automation",
      cta: "Start Free Trial",
      popular: true,
      features: [
        ...
        { name: "InsightOS™ - Autonomous AI Analytics & Insights", included: true },
        ...
        { name: "$100/mo AI credits included", included: true },
    ...
    },
    {
      name: "Enterprise",
      price: "$2,999",
      savings: "Save $60k/month",
      roi: "20x ROI",
      description: "Complete workforce automation platform at scale",
      cta: "Contact Sales",
      features: [
