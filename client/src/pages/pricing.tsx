  ...
  const tiers: PricingTier[] = [
    {
      ...
      features: [
        ...
        { name: "Manager assignments (RBAC)", included: false },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Custom integrations (coming 2025)", included: false },
        { name: "API access & webhooks (coming 2025)", included: false },
        { name: "White-label options (coming 2025)", included: false },
        { name: "SSO/SAML (coming 2025)", included: false },
        { name: "Audit compliance (coming 2025)", included: false },
        { name: "Auto-payroll (coming 2025)", included: false },
        { name: "GPS verification (coming 2025)", included: false },
      ],
    },
  ];
