  ...
  return (
    <CanvasHubPage config={dashboardPageConfig}>
      ...
      {isLoadingDashboard && (
        ...
        {/* Support Email Inbox — visible for all platform staff (support org) */}
        {isPlatformStaff && !['support_manager', 'support_agent'].includes(platformRole || '') && (
          <div className="mb-6">
            <div className="bg-card border border-border rounded-lg p-4 flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-foreground">Support Email Inbox</p>
