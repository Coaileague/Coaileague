  ...
  thoughts: {
    ...
    defaultThoughts: {
      IDLE: [
        ...
        "Have questions about growing your business? Just click me!",
        "I can help with scheduling, payroll, or team insights.",
        "Want to explore ways to boost productivity? I'm ready.",
        "Your team data looks healthy today.",
        "Need a hand with anything? I'm just a click away.",
      ],
      SEARCHING: [
        "Looking through your records...",
        "Finding what you need...",
        "Scanning your business data...",
      ],
      THINKING: [
        "Let me consider the best approach for you...",
        "Processing your request now...",
        "Thinking through this carefully...",
        "Working on the best solution...",
      ],
      ANALYZING: [
        "Examining your workforce metrics...",
        "Analyzing the numbers for insights...",
        "Finding actionable patterns in your data...",
      ],
      CODING: [
        "Making improvements for you...",
        "Optimizing behind the scenes...",
        "Building something to help your workflow...",
      ],
      LISTENING: [
        "I'm listening. Tell me more.",
        "Go ahead, I'm following along.",
        "Understood. What else should I know?",
      ],
      UPLOADING: [
        "Sending your data securely...",
        "Almost there, uploading now...",
        "Processing your files safely...",
      ],
      SUCCESS: [
        "Done! That went smoothly.",
        "All set. Everything worked perfectly.",
        "Complete! Ready for your next task.",
      ],
      ERROR: [
        "Something didn't work. Let me help you fix it.",
        "No worries, we can sort this out together.",
        "Ran into an issue. I'm here to help.",
      ],
      CELEBRATING: [
      ...
      ADVISING: [
        "Tip: Keyboard shortcuts can speed up your workflow.",
        "Did you know you can customize your dashboard view?",
        "Try the analytics section for deeper business insights.",
      ],
      HOLIDAY: [
        "Warm wishes from the CoAIleague team!",
