...
const ensureOnboardingEnabled = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
...
const requireWorkspace = (req: AuthenticatedRequest, res: Response, next: NextFunction) => {
