...
export async function generateChatPDF(data: ExportData): Promise<Buffer> {
  return new Promise((resolve, reject) => {
    ...
    doc
      .fontSize(20)
      .fillColor('#10b981')
      .text('AutoForce™ Chat Export', { align: 'center' });
...
<body>
  <div class="container">
    ...
    <footer>
      <p>This chat transcript was generated by AutoForce™ Autonomous Workforce Management Solutions</p>
