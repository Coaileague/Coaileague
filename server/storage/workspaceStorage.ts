...
export const createWorkspace = (data: Record<string, unknown>) => storage.createWorkspace(data);
export const updateWorkspace = (id: string, data: Record<string, unknown>) => storage.updateWorkspace(id, data);
