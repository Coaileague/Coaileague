  ...
  helpaiOrchestrator.registerAction({
    ...
    handler: async (request) => {
      ...
      const result = await shiftRoomBotOrchestrator.createShiftRoomOnAssignment({
        ...
        officerName,
        createdBy: request.context?.userId || 'trinity',
      });
  ...
  helpaiOrchestrator.registerAction({
    ...
    handler: async (request) => {
      ...
      await shiftRoomBotOrchestrator.handleShiftRoomMessage({
        ...
        senderId: request.context?.userId || 'trinity',
        senderName: request.context?.userName || 'Trinity',
  ...
  helpaiOrchestrator.registerAction({
    ...
    handler: async (request) => {
      ...
      const result = await meetingBotPdfService.generateAndSaveMeetingSummary(
        ...
        endedByName || request.context?.userName || 'Trinity'
      );
  ...
  helpaiOrchestrator.registerAction({
    ...
    handler: async (request) => {
      ...
      await shiftRoomBotOrchestrator.handleShiftRoomMessage({
        conversationId, workspaceId,
        senderId: request.context?.userId || 'trinity',
        senderName: askerName || request.context?.userName || 'Trinity',
        senderRole: 'employee',
