...
const CORE_PLATFORM_FACTS: SelfAwarenessFact[] = [
  ...
  },
  {
    ...
    factKey: 'os_modules',
    factValue: JSON.stringify([
      'Smart Scheduling — AI-powered shift scheduling and workforce planning',
      'Smart Time — GPS time tracking and attendance management',
      'Smart Payroll — Payroll processing',
      'Smart Billing — Client billing, invoicing and AR management',
      'Smart Hiring — Recruitment pipeline and employee onboarding',
      'Smart Reporting — Reports and analytics',
      'Smart Support — Help desk and tickets',
      'Smart Communications — Chat and notifications',
    ]),
    factType: 'list',
    source: 'system',
    confidence: 1.0,
