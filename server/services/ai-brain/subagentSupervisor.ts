...
const DEFAULT_SUBAGENTS: Omit<InsertAiSubagentDefinition, 'id' | 'createdAt' | 'updatedAt'>[] = [
  ...
  },
  {
    ...
    capabilities: ['notifications.send_platform_update', 'notifications.broadcast_message', 'notifications.send_to_user', 'notifications.create_maintenance_alert', 'notifications.get_stats'],
