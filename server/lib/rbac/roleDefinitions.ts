...
// arrays live here. Both server/rbac.ts and server/lib/businessRules.ts import
// from this file — never the other way around.
//
// Phase 9 RBAC Audit fixes applied:
//   F-2: org_admin added to LEADER_ROLES (was incorrectly excluded)
//   F-3: canAssignRole now uses WORKSPACE_ROLE_HIERARCHY (removed stale 4-role map)
//   F-10: this file created as canonical source
// ============================================================================
