  ...
  for (const table of criticalTables) {
    try {
      ...
      record({
        ...
        phase: 'DB_INTEGRITY',
        passed: false,
        details: `Missing or error: ${e instanceof Error ? e.message : String(e)}`,
        severity: 'critical'
      });
    }
  }
...
async function phase3_core_entity_queries() {
  ...
  } catch (e: unknown) { record({ name: 'User Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Workspace Members Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Employee Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Client Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Shift Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Time Entry Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
  ...
  } catch (e: unknown) { record({ name: 'Invoice Query', phase: 'CORE_CRUD', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
...
async function phase5_billing_credits() {
  ...
  } catch (e: unknown) { record({ name: 'Credit Account', phase: 'BILLING', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' }); }
  ...
  } catch (e: unknown) { record({ name: 'Credit Transaction History', phase: 'BILLING', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
...
async function phase7_communications() {
  ...
  } catch (e: unknown) { record({ name: 'Chat Messages', phase: 'COMMS', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
  ...
  } catch (e: unknown) { record({ name: 'Chat Conversations', phase: 'COMMS', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
  ...
  } catch (e: unknown) { record({ name: 'Support Rooms', phase: 'COMMS', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
  ...
  } catch (e: unknown) { record({ name: 'Notifications', phase: 'COMMS', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
...
async function phase8_compliance() {
  ...
  } catch (e: unknown) { record({ name: 'Compliance Documents', phase: 'COMPLIANCE', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
  ...
  } catch (e: unknown) { record({ name: 'Compliance Alerts', phase: 'COMPLIANCE', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
...
async function phase9_trinity_ai() {
  ...
  } catch (e: unknown) { record({ name: 'Decision Log Table', phase: 'TRINITY_AI', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'high' }); }
...
async function phase14_production_readiness() {
  ...
  try {
    ...
    record({ name: 'Database Connectivity', phase: 'PRODUCTION', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' });
  }
  ...
  try {
    ...
    record({ name: 'Processed Stripe Events Table', phase: 'PRODUCTION', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' });
  }
}
...
export async function runFullSystemStressTest(): Promise<TestResult[]> {
  ...
  for (const phase of phases) {
    ...
    try {
      ...
      console.error(`Phase error: ${e instanceof Error ? e.message : String(e)}`);
      record({ name: `${phase.name} (CRASH)`, phase: 'SYSTEM', passed: false, details: e instanceof Error ? e.message : String(e), severity: 'critical' });
    }
  }
