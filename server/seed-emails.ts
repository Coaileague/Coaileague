...
const EMAIL_TEMPLATES: EmailTemplate[] = [
  ...
  { subject: "Vehicle break-in in employee parking lot", body: "Two employees reported their vehicles were broken into during the night shift. Windows smashed, personal items stolen. Police report #2024-5847 has been filed.", category: "incident", priority: "medium" },
  { subject: "Fire alarm activation - False alarm confirmed", body: "The fire alarm was triggered in Building C at 11:42 PM due to a malfunctioning smoke detector. Fire department responded, confirmed false alarm. Maintenance has been notified.", category: "incident", priority: "medium" },
  ...
  { subject: "Theft from employee locker room", body: "Multiple employees reported personal items missing from the locker room. Security reviewing footage. Affected employees: Martinez, Chen, Williams.", category: "incident", priority: "medium" },
  ...
  { subject: "Equipment malfunction - Card reader failure", body: "Access card readers at the north entrance are not functioning. Manual log-in procedures implemented until repairs complete.", category: "incident", priority: "medium" },
  { subject: "Vandalism discovered in restroom facilities", body: "Significant vandalism discovered in the second-floor men's restroom. Mirrors broken, sinks damaged. Reviewing footage to identify responsible party.", category: "incident", priority: "medium" },
  ...
  // === SCHEDULING (15) ===
  { subject: "Shift swap request - Sarah and Michael", body: "Sarah Johnson is requesting to swap her Thursday evening shift with Michael Chen's Friday morning shift. Both parties have agreed. Please approve in the system.", category: "scheduling", priority: "medium" },
  ...
  { subject: "Holiday schedule draft for review", body: "Attached is the proposed holiday schedule for December. Please review and provide feedback by Friday. Key dates: Christmas Eve, Christmas Day, New Year's Eve.", category: "scheduling", priority: "medium" },
  { subject: "Request for reduced hours - Emma Williams", body: "Emma Williams is requesting to move to part-time status (20 hours/week) starting next month due to family obligations. Please process accordingly.", category: "scheduling", priority: "medium" },
  ...
  { subject: "Overtime approval request - Multiple employees", body: "Several employees have accumulated overtime this week: Davis (8 hrs), Martinez (12 hrs), Chen (6 hrs). Requesting approval for payroll processing.", category: "scheduling", priority: "medium" },
  { subject: "Training schedule conflict - Need resolution", body: "The mandatory compliance training scheduled for Tuesday conflicts with three employees' shifts. Need to either reschedule or find coverage.", category: "scheduling", priority: "medium" },
  ...
  { subject: "On-call schedule for next month", body: "Please find attached the on-call rotation for February. Review and confirm availability. Any conflicts must be reported within 48 hours.", category: "scheduling", priority: "medium" },
  { subject: "Shift bid period opening next week", body: "The quarterly shift bid period opens Monday. Seniority-based selection as per union agreement. All preferences due by Friday 5 PM.", category: "scheduling", priority: "medium" },
  ...
  { subject: "Jury duty notification - Officer Thompson", body: "Officer Thompson has been summoned for jury duty starting November 12. Expected duration 1-2 weeks. Need to arrange coverage.", category: "scheduling", priority: "medium" },
  { subject: "Summer schedule adjustments needed", body: "With three employees taking extended summer vacations, we need to adjust the June-August schedules. Draft attached for review.", category: "scheduling", priority: "medium" },
  ...
  { subject: "Background check renewal required", body: "Per company policy, 5-year background check renewals are required for: Chen, Williams, Thompson. Please initiate the process.", category: "compliance", priority: "medium" },
  ...
  { subject: "CPR certification expiring - 8 employees", body: "Eight employees have CPR/First Aid certifications expiring next month. Training class scheduled for November 20. Please confirm attendance.", category: "compliance", priority: "medium" },
  ...
  { subject: "Uniform compliance audit results", body: "Recent uniform inspection revealed 4 employees not meeting dress code standards. Warning notices have been issued. Please review attached report.", category: "compliance", priority: "medium" },
  { subject: "Client contract renewal - Compliance review needed", body: "The TechCorp contract renewal requires an updated compliance certification. Legal and HR must verify all requirements are met.", category: "compliance", priority: "medium" },
  ...
  { subject: "Privacy training completion reminder", body: "Annual privacy and data protection training must be completed by all staff by month end. 12 employees have not yet completed the module.", category: "compliance", priority: "medium" },
  { subject: "Fire safety inspection - Minor violations found", body: "Yesterday's fire inspection identified 3 minor violations: blocked exit (corrected), expired extinguisher (replaced), missing signage (ordered).", category: "compliance", priority: "medium" },
  { subject: "New hire orientation checklist incomplete", body: "New employees Garcia and Thompson have incomplete orientation checklists. Missing: security acknowledgment, equipment sign-off, emergency procedures.", category: "compliance", priority: "medium" },
  ...
  { subject: "Performance improvement plan - James Davis", body: "Following multiple tardiness incidents, James Davis has been placed on a 30-day performance improvement plan. Documentation attached.", category: "hr", priority: "medium" },
  { subject: "New hire paperwork complete - Ready for onboarding", body: "All background checks and paperwork cleared for new hire Robert Kim. Start date: Monday. Please prepare training schedule and equipment.", category: "hr", priority: "medium" },
  { subject: "FMLA leave request - Employee medical condition", body: "Michael Chen has requested FMLA leave for a recurring medical condition. Medical certification received. Intermittent leave approved.", category: "hr", priority: "medium" },
  ...
  { subject: "Annual review schedule for November", body: "Annual performance reviews must be completed for all employees by November 30. Attached is the schedule and evaluation forms.", category: "hr", priority: "medium" },
  { subject: "Pay raise request - Lisa Martinez", body: "Lisa Martinez has formally requested a pay increase citing market rates and 3 years of service. Current rate: $70/hr. Requesting $75/hr.", category: "hr", priority: "medium" },
  ...
  { subject: "Benefits enrollment deadline reminder", body: "Open enrollment ends November 30. 8 employees have not made selections for next year's benefits. Reminder emails sent.", category: "hr", priority: "medium" },
  { subject: "Promotion recommendation - Field Specialist", body: "Supervisor recommends Emma Williams for promotion to Lead Field Specialist. Excellent performance record, positive client feedback, leadership skills demonstrated.", category: "hr", priority: "medium" },
  ...
  { subject: "Workplace accommodation request", body: "Employee Thompson has requested workplace accommodation under ADA. Request: modified patrol route due to knee surgery recovery. Medical documentation attached.", category: "hr", priority: "medium" },
  ...
  { subject: "Team morale concern flagged by supervisor", body: "Supervisor reports declining morale at the Healthcare Plus site. Suggested causes: understaffing, difficult client demands. Team meeting recommended.", category: "hr", priority: "medium" },
  ...
  { subject: "Contract amendment request - Additional services", body: "Healthcare Plus is requesting to add parking lot patrol services to their existing contract. Proposal and pricing needed by Friday.", category: "client", priority: "medium" },
  ...
  { subject: "New client onboarding - Acme Industries", body: "Welcome packet needed for new client Acme Industries. Contract signed for 3 officers, 24/7 coverage. Start date: December 1.", category: "client", priority: "medium" },
  ...
  { subject: "Client contract expiring - Renewal discussion", body: "The Retail Solutions contract expires December 31. Account manager should schedule renewal discussion. Client satisfaction rating: 4.2/5.", category: "client", priority: "medium" },
  { subject: "Emergency contact update - Client personnel changes", body: "TechCorp has new after-hours emergency contacts following personnel changes. Updated contact list attached. Please distribute to all site officers.", category: "client", priority: "medium" },
  ...
  { subject: "Special event security request", body: "Healthcare Plus is hosting a charity gala on November 22. Requesting 6 additional officers for event security. Premium rate authorized.", category: "client", priority: "medium" },
  ...
  { subject: "Site-specific training requirement from client", body: "Retail Solutions now requires all officers to complete their proprietary customer service training (4 hours). Scheduling needed for 8 officers.", category: "client", priority: "medium" },
  { subject: "Client requesting dedicated account manager", body: "TechCorp (our largest client) is requesting a dedicated account manager rather than shared supervision. Resource allocation decision needed.", category: "client", priority: "medium" },
  ...
  { subject: "Client site relocation notification", body: "Healthcare Plus is relocating their admin offices effective January 1. New address attached. Update all records and inform assigned staff.", category: "client", priority: "medium" },
  ...
  { subject: "Direct deposit update - New bank account", body: "Employee Davis submitted direct deposit change form. New account verification complete. Effective for next pay period.", category: "payroll", priority: "medium" },
  { subject: "Bonus processing request - Q3 performance", body: "Q3 performance bonuses approved for 5 employees: Johnson ($500), Chen ($750), Williams ($400), Davis ($350), Martinez ($600). Process for Nov 15 payroll.", category: "payroll", priority: "medium" },
  { subject: "Tax withholding update - W-4 change", body: "Employee Thompson submitted new W-4 claiming additional withholding allowances. Verify and update system before next payroll.", category: "payroll", priority: "medium" },
  ...
  { subject: "Year-end payroll deadlines approaching", body: "Reminder: Last payroll of the year is December 27. All adjustments, corrections, and bonuses must be submitted by December 20.", category: "payroll", priority: "medium" },
  ...
  { subject: "Commission calculation review - Account manager", body: "Q3 commission calculation for Account Manager shows $2,340 earned. Please verify against contract new client bonus formula.", category: "payroll", priority: "medium" },

  // === TRAINING (10) ===
  { subject: "New employee training schedule - Week 1", body: "Training schedule for new hire Robert Kim: Day 1 - Orientation, Day 2-3 - Safety procedures, Day 4-5 - Site-specific training at TechCorp.", category: "training", priority: "medium" },
  ...
  { subject: "Advanced security certification course available", body: "State-approved advanced security certification course offered December 5-7. Company will cover cost for interested employees. Sign-up deadline: Nov 20.", category: "training", priority: "medium" },
  { subject: "Training failure notification - Remediation needed", body: "Employee Rodriguez failed the post-training assessment (score: 62%, passing: 75%). Remediation training scheduled for next week.", category: "training", priority: "medium" },
  ...
  { subject: "Field training officer assignment", body: "Officer Johnson has been selected as Field Training Officer (FTO) for new hires. Additional $2/hr differential approved during training periods.", category: "training", priority: "medium" },
  ...
  { subject: "Online training platform access issues", body: "Multiple employees reporting login issues with the training platform. IT investigating. Workaround: clear browser cache or use incognito mode.", category: "training", priority: "medium" },
  { subject: "Train-the-trainer session for supervisors", body: "All supervisors required to attend train-the-trainer session November 18. Topic: New reporting procedures and incident documentation.", category: "training", priority: "medium" },

  // === SYSTEM / OPERATIONS (5) ===
  { subject: "System maintenance scheduled - Downtime notice", body: "The scheduling system will be down for maintenance Saturday 2-6 AM. Please complete any urgent scheduling changes before then.", category: "system", priority: "medium" },
  { subject: "New mobile app version released", body: "Version 2.5 of the officer mobile app is now available. Key updates: improved GPS accuracy, offline incident reports, photo attachments. Update required by Nov 30.", category: "system", priority: "medium" },
  { subject: "Radio system upgrade complete", body: "The radio communication system upgrade is complete. New channel assignments attached. All officers must test their equipment before next shift.", category: "system", priority: "medium" },
  { subject: "Patrol route optimization recommendations", body: "Based on incident data analysis, Trinity AI recommends adjusting patrol routes at TechCorp site. Proposed changes attached for review.", category: "system", priority: "medium", requiresTrinityAction: true },
  ...
  { subject: "Request: Trinity AI analysis of incident patterns", body: "Please have Trinity analyze the past 6 months of incident reports for the Healthcare Plus site. Looking for patterns, peak times, and prevention recommendations.", category: "trinity_request", priority: "medium", requiresTrinityAction: true },
  ...
  { subject: "AI Schedule optimization request", body: "Can Trinity optimize next month's schedule to minimize overtime while ensuring coverage? Current projected OT: 120 hours. Target: under 80 hours.", category: "trinity_request", priority: "medium", requiresTrinityAction: true },
